 ...
 * 
 * @modify 15-12-2020 by Francesco "Abbadon1334" Danti for Kasuken Project
 */
...
function loadLiquidFillGauge(elementId, value, config) {
    ...
    var coloredCircleFiller = fillCircleGroup.append("circle")
        .attr("cx", radius)
        .attr("cy", radius)
    ...
    function GaugeUpdater() {
        this.update = function (value, color) {
            coloredCircleFiller.style("fill", color);
